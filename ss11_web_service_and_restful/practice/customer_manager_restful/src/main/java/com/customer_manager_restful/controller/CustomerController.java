package com.customer_manager_restful.controller;

import com.customer_manager_restful.model.Customer;
import com.customer_manager_restful.service.ICustomerService;
...
public class CustomerController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Customer> findCustoomerById(@PathVariable Long id) {
