...
@WebServlet(name = "TheMuonSachServlet", value = "/muon")
public class TheMuonSachServlet extends HttpServlet {
    ...
    private void listSachDTO(HttpServletRequest request, HttpServletResponse response) throws SQLException,
        ...
        List<MuonSachDTO> muonSachDTOList = iSachService.selectAllWithDTO();
        request.setAttribute("muonSachDTOList", muonSachDTOList);
        RequestDispatcher dispatcher = request.getRequestDispatcher("muon/list.jsp");
        try {
